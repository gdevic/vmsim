...
#include "Scanner.h"                // Some custom flags used in master tables
...
/* 06 */        _push      ,1  ,_ES ,0   ,0   ,v_push_es         ,0, 0,
/* 07 */        _pop       ,1  ,_ES ,0   ,0   ,v_pop_es          ,0, 0,
...
/* 0E */        _push      ,1  ,_CS ,0   ,0   ,v_push_cs         ,0, 0,
...
/* 16 */        _push      ,1  ,_SS ,0   ,0   ,v_push_ss         ,0, 0,
/* 17 */        _pop       ,1  ,_SS ,0   ,0   ,v_pop_ss          ,0, 0,
...
/* 1E */        _push      ,1  ,_DS ,0   ,0   ,v_push_ds         ,0, 0,
/* 1F */        _pop       ,1  ,_DS ,0   ,0   ,v_pop_ds          ,0, 0,
...
/* 6C */        _insb      ,2  ,_Yb ,_DX ,0   ,v_insb            ,0, SCAN_TERMINATING,
/* 6D */        _insw      ,2  ,_Yv ,_DX ,0   ,v_insv            ,0, SCAN_TERMINATING | DIS_NAME_FLAG,
/* 6E */        _outsb     ,2  ,_DX ,_Xb ,0   ,v_outsb           ,0, SCAN_TERMINATING,
/* 6F */        _outsw     ,2  ,_DX ,_Xv ,0   ,v_outsv           ,0, SCAN_TERMINATING | DIS_NAME_FLAG,
...
/* 87 */        _xchg      ,2  ,_Ev ,_Gv ,0   ,0 /* trapping */  ,INSTR_READ_WRITE | INSTR_WORD_DWORD, DIS_MODRM,
/* 88 */        _mov       ,2  ,_Eb ,_Gb ,0   ,0 /* trapping */  ,INSTR_WRITE | INSTR_BYTE, DIS_MODRM,
/* 89 */        _mov       ,2  ,_Ev ,_Gv ,0   ,0 /* trapping */  ,INSTR_WRITE | INSTR_WORD, DIS_MODRM,
/* 8A */        _mov       ,2  ,_Gb ,_Eb ,0   ,0 /* trapping */  ,INSTR_READ | INSTR_BYTE, DIS_MODRM,
/* 8B */        _mov       ,2  ,_Gv ,_Ev ,0   ,0                 ,0, DIS_MODRM,
/* 8C */        _mov       ,2  ,_Ew ,_Sw ,0   ,v_mov_from_seg,    0, DIS_MODRM,
/* 8D */        _lea       ,2  ,_Gv ,_M  ,0   ,0                 ,0, DIS_MODRM,
/* 8E */        _mov       ,2  ,_Sw ,_Ew ,0   ,v_mov_to_seg,      0, SCAN_TERM_PMODE | DIS_MODRM,
...
/* 9A */        _call      ,1  ,_Ap ,0   ,0   ,v_call_far,        0, SCAN_SINGLE_STEP,
/* 9B */        _wait      ,0  ,0   ,0   ,0   ,0                 ,0, 0,
/* 9C */        _pushf     ,0  ,0   ,0   ,0   ,v_pushf,           0, SCAN_TERMINATING | DIS_NAME_FLAG,
/* 9D */        _popf      ,0  ,0   ,0   ,0   ,v_popf,            0, SCAN_TERMINATING | DIS_NAME_FLAG,
/* 9E */        _sahf      ,0  ,0   ,0   ,0   ,0                 ,0, 0,
/* 9F */        _lahf      ,0  ,0   ,0   ,0   ,0                 ,0, 0,

/* A0 */        _mov       ,2  ,_AL ,_O  ,0   ,0                 ,0, 0,
/* A1 */        _mov       ,2  ,_eAX,_O  ,0   ,0 /* trapping */  ,INSTR_READ | INSTR_WORD_DWORD, 0,
/* A2 */        _mov       ,2  ,_O  ,_AL ,0   ,0                 ,0, 0,
/* A3 */        _mov       ,2  ,_O  ,_eAX,0   ,0 /* trapping */  ,INSTR_WRITE | INSTR_WORD_DWORD, 0,
/* A4 */        _movsb     ,2  ,_Yb ,_Xb ,0   ,f_movsb           ,0, 0,
/* A5 */        _movsw     ,2  ,_Yv ,_Xv ,0   ,f_movsv           ,0, DIS_NAME_FLAG,
/* A6 */        _cmpsb     ,2  ,_Xb ,_Yb ,0   ,0                 ,0, 0,
/* A7 */        _cmpsw     ,2  ,_Xv ,_Yv ,0   ,0                 ,0, DIS_NAME_FLAG,
/* A8 */        _test      ,2  ,_AL ,_Ib ,0   ,0                 ,0, 0,
/* A9 */        _test      ,2  ,_eAX,_Iv ,0   ,0                 ,0, 0,
/* AA */        _stosb     ,2  ,_Yb ,_AL ,0   ,f_stosb           ,0, 0,
/* AB */        _stosw     ,2  ,_Yb ,_eAX,0   ,f_stosv           ,0, DIS_NAME_FLAG,
/* AC */        _lodsb     ,2  ,_AL ,_Xb ,0   ,0 /* trapping */  ,INSTR_READ | INSTR_BYTE, 0,
/* AD */        _lodsw     ,2  ,_eAX,_Xv ,0   ,0 /* trapping */  ,INSTR_READ | INSTR_WORD_DWORD, DIS_NAME_FLAG,
...
/* C2 */        _ret       ,1  ,_Iw ,0   ,0   ,v_ret_near_pop,    0, SCAN_SINGLE_STEP,
/* C3 */        _ret       ,0  ,0   ,0   ,0   ,v_ret_near,        0, SCAN_SINGLE_STEP,
/* C4 */        _les       ,2  ,_Gv ,_Mp ,0   ,v_les,             0, SCAN_TERM_PMODE | DIS_MODRM,
/* C5 */        _lds       ,2  ,_Gv ,_Mp ,0   ,v_lds,             0, SCAN_TERM_PMODE | DIS_MODRM,
/* C6 */        _mov       ,2  ,_Eb ,_Ib ,0   ,0                 ,0, DIS_MODRM,
/* C7 */        _mov       ,2  ,_Ev ,_Iv ,0   ,0                 ,0, DIS_MODRM,
/* C8 */        _enter     ,2  ,_Iw ,_Ib ,0   ,0                 ,0, 0,
/* C9 */        _leave     ,0  ,0   ,0   ,0   ,0                 ,0, 0,
/* CA */        _retf      ,1  ,_Iw ,0   ,0   ,v_ret_far_pop,     0, SCAN_SINGLE_STEP,
/* CB */        _retf      ,0  ,0   ,0   ,0   ,v_ret_far,         0, SCAN_SINGLE_STEP,
/* CC */        _int       ,1  ,_3  ,0   ,0   ,0                 ,0, 0,
/* CD */        _int       ,1  ,_Ib ,0   ,0   ,v_int_n,           0, SCAN_TERMINATING,
/* CE */        _into      ,0  ,0   ,0   ,0   ,v_into,            0, SCAN_TERMINATING,
/* CF */        _iret      ,0  ,0   ,0   ,0   ,v_iret,            0, SCAN_TERMINATING,
...
/* E4 */        _in        ,2  ,_AL ,_Ib ,0   ,v_inb,             0, SCAN_TERMINATING,
/* E5 */        _in        ,2  ,_eAX,_Ib ,0   ,v_inv,             0, SCAN_TERMINATING,
/* E6 */        _out       ,2  ,_Ib ,_AL ,0   ,v_outb,            0, SCAN_TERMINATING,
/* E7 */        _out       ,2  ,_Ib ,_eAX,0   ,v_outv,            0, SCAN_TERMINATING,
/* E8 */        _call      ,1  ,_Jv ,0   ,0   ,v_call_near,       0, SCAN_COND_JUMP,
/* E9 */        _jmp       ,1  ,_Jv ,0   ,0   ,v_jmp_near2,       0, SCAN_JUMP,
/* EA */        _jmpf      ,1  ,_Ap ,0   ,0   ,v_jmp_far,         0, SCAN_TERMINATING,
/* EB */        _jmp       ,1  ,_Jb ,0   ,0   ,v_jmp_near,        0, SCAN_JUMP,
/* EC */        _in        ,2  ,_AL ,_DX ,0   ,v_inal,            0, SCAN_TERMINATING,
/* ED */        _in        ,2  ,_eAX,_DX ,0   ,v_inax,            0, SCAN_TERMINATING,
/* EE */        _out       ,2  ,_DX ,_AL ,0   ,v_outal,           0, SCAN_TERMINATING,
/* EF */        _out       ,2  ,_DX ,_eAX,0   ,v_outax,           0, SCAN_TERMINATING,

/* F0 */        _lock      ,0  ,0   ,0   ,0   ,0                 ,0, 0,
/* F1 */        _NDEF      ,0  ,0   ,0   ,0   ,0                 ,0, DIS_SPECIAL,
/* F2 */        _REPNE     ,0  ,0   ,0   ,0   ,0                 ,0, DIS_SPECIAL,
/* F3 */        _REP       ,0  ,0   ,0   ,0   ,0                 ,0, DIS_SPECIAL,
/* F4 */        _hlt       ,0  ,0   ,0   ,0   ,v_hlt,             0, SCAN_TERMINATING,
...
/* FA */        _cli       ,0  ,0   ,0   ,0   ,v_cli,             0, SCAN_TERMINATING,
/* FB */        _sti       ,0  ,0   ,0   ,0   ,v_sti,             0, SCAN_TERMINATING,
...
/* 0F 02 */     _lar       ,2  ,_Gv ,_Ew ,0   ,v_lar,             0, DIS_MODRM,
/* 0F 03 */     _lsl       ,2  ,_Gv ,_Ew ,0   ,v_lsl,             0, DIS_MODRM,
/* 0F 04 */     _NDEF      ,0  ,0   ,0   ,0   ,0                 ,0, DIS_SPECIAL,
/* 0F 05 */     _loadall   ,0  ,0   ,0   ,0   ,0                 ,0, 0,
/* 0F 06 */     _clts      ,0  ,0   ,0   ,0   ,v_clts,            0, SCAN_TERMINATING,
/* 0F 07 */     _NDEF      ,0  ,0   ,0   ,0   ,0                 ,0, DIS_SPECIAL,
/* 0F 08 */     _invd      ,0  ,0   ,0   ,0   ,v_invd,            0, SCAN_TERMINATING,
/* 0F 09 */     _wbinv     ,0  ,0   ,0   ,0   ,v_wbinvd,          0, SCAN_TERMINATING,
...
/* 0F 20 */     _mov       ,2  ,_Rd ,_Cd ,0   ,v_mov_from_cr,     0, SCAN_TERMINATING | DIS_MODRM,
/* 0F 21 */     _mov       ,2  ,_Rd ,_Dd ,0   ,v_mov_from_dr,     0, SCAN_TERMINATING | DIS_MODRM,
/* 0F 22 */     _mov       ,2  ,_Cd ,_Rd ,0   ,v_mov_to_cr,       0, SCAN_TERMINATING | DIS_MODRM,
/* 0F 23 */     _mov       ,2  ,_Dd ,_Rd ,0   ,v_mov_to_dr,       0, SCAN_TERMINATING | DIS_MODRM,
...
/* 0F 30 */     _wrmsr     ,0  ,0   ,0   ,0   ,v_wrmsr,           0, SCAN_TERMINATING,
/* 0F 31 */     _rdtsc     ,0  ,0   ,0   ,0   ,v_rdtsc,           0, SCAN_TERMINATING,
/* 0F 32 */     _rdmsr     ,0  ,0   ,0   ,0   ,v_rdmsr,           0, SCAN_TERMINATING,
/* 0F 33 */     _rdpmc     ,0  ,0   ,0   ,0   ,v_rdpmc,           0, SCAN_TERMINATING,
...
/* 0F A0 */     _push      ,1  ,_FS ,0   ,0   ,v_push_fs,         0, 0,
/* 0F A1 */     _pop       ,1  ,_FS ,0   ,0   ,v_pop_fs,          0, 0,
/* 0F A2 */     _cpuid     ,0  ,0   ,0   ,0   ,v_cpuid,           0, SCAN_TERMINATING,
...
/* 0F A8 */     _push      ,1  ,_GS ,0   ,0   ,v_push_gs,         0, 0,
/* 0F A9 */     _pop       ,1  ,_GS ,0   ,0   ,v_pop_gs,          0, 0,
...
/* 0F B2 */     _lss       ,2  ,_Gv ,_Mp ,0   ,v_lss,             0, SCAN_TERM_PMODE | DIS_MODRM,
/* 0F B3 */     _btr       ,2  ,_Ev ,_Gv ,0   ,0                 ,0, DIS_MODRM,
/* 0F B4 */     _lfs       ,2  ,_Gv ,_Mp ,0   ,v_lfs,             0, SCAN_TERM_PMODE | DIS_MODRM,
/* 0F B5 */     _lgs       ,2  ,_Gv ,_Mp ,0   ,v_lgs,             0, SCAN_TERM_PMODE | DIS_MODRM,
...
/* 010 */       _call      ,1  ,_Ev ,0   ,0   ,v_call_neari,      0, SCAN_SINGLE_STEP,
/* 011 */       _call      ,1  ,_Ep ,0   ,0   ,v_call_far,        0, SCAN_SINGLE_STEP,
/* 100 */       _jmp       ,1  ,_Ev ,0   ,0   ,v_jmp_near,        0, SCAN_SINGLE_STEP,
/* 101 */       _jmp       ,1  ,_Ep ,0   ,0   ,v_jmp_fari,        0, SCAN_SINGLE_STEP,
/* 110 */       _push      ,1  ,_Ev ,0   ,0   ,0                 ,0, 0,
/* 111 */       _NDEF      ,0  ,0   ,0   ,0   ,0                 ,0, DIS_SPECIAL,

/* Group 6  */  _sldt      ,1  ,_Ew ,0   ,0   ,v_sldt,            0, SCAN_TERMINATING,
/* 001 */       _str       ,1  ,_Ew ,0   ,0   ,v_str,             0, SCAN_TERMINATING,
/* 010 */       _lldt      ,1  ,_Ew ,0   ,0   ,v_lldt,            0, SCAN_TERMINATING,
/* 011 */       _ltr       ,1  ,_Ew ,0   ,0   ,v_ltr,             0, SCAN_TERMINATING,
/* 100 */       _verr      ,1  ,_Ew ,0   ,0   ,v_verr,            0, 0,
/* 101 */       _verw      ,1  ,_Ew ,0   ,0   ,v_verw,            0, 0,
/* 110 */       _NDEF      ,0  ,0   ,0   ,0   ,0                 ,0, DIS_SPECIAL,
/* 111 */       _NDEF      ,0  ,0   ,0   ,0   ,0                 ,0, DIS_SPECIAL,

/* Group 7  */  _sgdt      ,1  ,_Ms ,0   ,0   ,v_sgdt,            0, SCAN_TERMINATING,
/* 001 */       _sidt      ,1  ,_Ms ,0   ,0   ,v_sidt,            0, SCAN_TERMINATING,
/* 010 */       _lgdt      ,1  ,_Ms ,0   ,0   ,v_lgdt,            0, SCAN_TERMINATING,
/* 011 */       _lidt      ,1  ,_Ms ,0   ,0   ,v_lidt,            0, SCAN_TERMINATING,
/* 100 */       _smsw      ,1  ,_Ew ,0   ,0   ,v_smsw,            0, SCAN_TERMINATING,
/* 101 */       _NDEF      ,0  ,0   ,0   ,0   ,0                 ,0, DIS_SPECIAL,
/* 110 */       _lmsw      ,1  ,_Ew ,0   ,0   ,v_lmsw,            0, SCAN_TERMINATING,
/* 111 */       _invpg     ,1  ,_M  ,0   ,0   ,v_invlpg,          0, SCAN_TERMINATING,
